...
echo ==========================================
echo 正在安裝/更新打包必備與專案套件...
pip install -r requirements.txt pyinstaller

echo.
echo 正在關閉可能運行中的程式...
taskkill /F /IM SnapTrans.exe /T 2>nul
